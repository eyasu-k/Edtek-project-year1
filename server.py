...
from constants import SERVER_FILES_FOLDER_NAME, SUCESS, FILES_DELIMITER
...
def send_file_list(client: socket.socket, *_)-> None:
    files = explorer.get_files_list(SERVER_FILES_FOLDER_NAME)
    files = FILES_DELIMITER.join(files)
